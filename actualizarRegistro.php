...
medicamentos, alergias, embarazos, condición psicológica y/o psiquiátrica, etc.)</option>
                                    ...
                                    <tr id="negative5" style="display: none;">
                                        ...
                                        <td>
                                            ...
                                            <select name="impRA[]" id="impRA" value="-1" class="form-control multi-select custom-select" style="outline-style: none; color:black" multiple data-selected-text-format="count" data-none-selected-text="Sin especificar">
                                                <?php
